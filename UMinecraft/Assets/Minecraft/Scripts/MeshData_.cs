...
namespace MyNamespace
{
  ...
  public  struct Vertex
    ...
    //    public Color[] _colors;
        ...
        public static int trianglIndexSize = 2;//uint16 2  int 4
        MeshData_(int c )
        {
        ...
        public void TransformVertices(Matrix4x4 mat)
        {
            ...
            {
              //  vertices[i] = mat.MultiplyPoint(vertices[i]);
            }
        }
        ...
        public static int maxCacah = 20000;
        ...
        public static void InitCacah()
        {
            ...
            for (int i = 0; i < iii; i++)
            {
              ...
              //  triangles[index + 1] = (UInt16)(i * 4 );
              //  triangles[index + 1] = (UInt16)( i * 4 + 1);
              //  triangles[index + 2] = (UInt16)(i * 4 + 2) ;
              //  triangles[index + 3] = (UInt16)(i * 4) ;
             //   triangles[index + 4] = (UInt16)(i * 4 + 2) ;
             //   triangles[index + 5] = (UInt16)(i * 4 + 3);

             //   index += 6;
            }
            MDPoolMax = new Queue<MeshData_>(600);
            MDPool24 = new Queue<MeshData_>(maxCacah * 4);
        ...
        public static int maxVertices = 30000;
